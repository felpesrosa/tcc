...
# primeiro Caso de Teste > executor do Tomcat com VirtualThreads
    ...
    do
        ...
        vegeta attack -duration=10s -rate=5000 -targets=./targets/1_Targers_with_delay.txt | vegeta report > ./results/vt/virtualThreads_loop_$iCT1.txt
...
# segundo Caso de Teste > executor do Tomcat com CachedThreads
    ...
    do
        ...
        vegeta attack -duration=10s -rate=5000 -targets=./targets/1_Targers_with_delay.txt | vegeta report > ./results/ct/cachedThreads_loop_$iCT2.txt
...
# terceiro Caso de Teste > executor do Tomcat com PlatformThreads
    ...
    do
        ...
        vegeta attack -duration=10s -rate=5000 -targets=./targets/1_Targers_with_delay.txt | vegeta report > ./results/pt/PlatformThreads_loop_$iCT3.txt
...
# quarto Caso de Teste > executor original do Tomcat
    ...
    do
        ...
        vegeta attack -duration=10s -rate=5000 -targets=./targets/1_Targers_with_delay.txt | vegeta report > ./results/original/nio_loop_$iCT4.txt
