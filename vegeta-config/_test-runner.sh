...
do
    ...
    vegeta attack -duration=5s -rate=1000 -targets=1-Target_with_Platform_Threads.txt | vegeta report > ./results/withPlatformThreads_loop_$i.txt
    ...
    vegeta attack -duration=5s -rate=1000 -targets=3-Target_with_Cached_Threads.txt | vegeta report > ./results/withCachedThreads_loop_$i.txt
    ...
    vegeta attack -duration=5s -rate=1000 -targets=2-Target_with_Single_Thread.txt | vegeta report > ./results/withSingleThread_loop_$i.txt
    ...
    vegeta attack -duration=5s -rate=1000 -targets=4-Target_with_Virtual_Threads.txt | vegeta report > ./results/withVirtualThreads_loop_$i.txt
